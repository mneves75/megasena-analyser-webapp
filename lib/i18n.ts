export const pt = {
  ...
  privacy: {
    ...
    sections: [
      ...
      },
      {
        ...
        link: {
          ...
          prefix: 'Para dúvidas sobre privacidade no Brasil, consulte a',
        },
      },
      {
    ...
    notice: 'Esta política pode ser atualizada. Recomendamos revisitá-la periodicamente.',
    faqs: [
      {
      ...
      },
      {
        ...
        answer:
          'Não. Não vendemos, alugamos ou compartilhamos dados com terceiros. Não temos parceiros de publicidade ou marketing.',
      },
      {
        question: 'Posso apagar meus dados?',
        answer:
          'Sim. Como os dados ficam no seu navegador, você pode apagá-los a qualquer momento limpando os dados do site nas configurações do navegador.',
      },
    ],
  },
  footer: {
