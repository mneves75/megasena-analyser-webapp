...
| Links `REPO_BASE`              | Baixa      | `src/app/stats/page.tsx:23`, `src/app/docs/page.tsx:13` | Base de links apontava para `megasena-analyser-webapp`; confirmado rename para `megasena-analyser-nextjs`. | ✅ `REPO_BASE_URL` + docs/instalação atualizados em 27/09/2025. |
