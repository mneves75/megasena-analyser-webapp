...
- Bun `>= 1.4.0` na máquina que gera o build (CI usa a versão exata em `.bun-ci-version`)
- Docker no servidor; a imagem de runtime usa Bun 1.4.0 estável pinado por digest imutável
